...
export default class LocaleProvider extends React.Component<ILocaleProviderProps, any> {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <LocaleContext.Consumer>
        {({ locale, toggleTheme }) =>
          React.cloneElement(children as React.ReactElement, { locale, onPress: toggleTheme })
        }
      </LocaleContext.Consumer>
    )
  }
