...
import { ICheckBoxStyles, styles } from './style'
...
class Item extends React.Component<ICheckboxItemProps> {
  static defaultProps: ICheckboxItemProps = {
    type: 'tag',
    checkedValues: [],
    layout: 'inline',
    value: '',
  ...
  render() {
    ...
    const ItemStyle: any = {
      inline_tag: (_style: ICheckBoxStyles) => (
        <View
          style={[
      ...
      inline_checkbox: (_style: ICheckBoxStyles) => (
...
export class Checkbox extends React.Component<ICheckboxProps, any> {
  ...
  renderChild = (props: ICheckboxProps) => {
  ...
  renderWarp = ({ style, _style }: { style: StyleProp<ViewStyle>; _style: ICheckBoxStyles }) => {
    return {
