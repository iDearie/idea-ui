...
export interface IUseThemeContextProps {
  theme?: PartialTheme
}
export const useTheme = (props: IUseThemeContextProps = {}) => {
  const theme = useContext(ThemeContext)
  return { ...theme, ...props.theme }
}

export interface IWithThemeProps<T, S> {
 ...
 */
export interface IWithThemeStyles<T> {
  styles?: Partial<T>
}
export class WithTheme<T, S> extends React.Component<IWithThemeProps<T, S>> {
  static defaultProps = {
    themeStyles: () => {},
  }
