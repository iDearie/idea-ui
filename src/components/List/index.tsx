...
import { styles, IListItemStyles } from './styles'
import { WithTheme } from '../Theme'

export interface IListItemProps {
  viewStyle?: StyleProp<ViewStyle> // Item组件根节点样式
  label?: string | number | React.ReactElement<any> | React.ReactElement[] // 组件左侧文字或者组件
  icon?: any // 左侧icon
  ...
  disabled?: boolean
  touchable?: boolean
  children?: React.ReactElement<any> | React.ReactElement[] | string | number | null
}

class Item extends React.PureComponent<IListItemProps> {
  static defaultProps = {
    separate: 0,
    borderBottom: 0.5,
    activeOpacity: 0.2,
  ...
  renderChild = (props: IListItemProps) => {
  ...
  render() {
    ...
    const renderContainer = (_style: IListItemStyles) => {
